...
def chain_corner_from_dir(dirname, parstxt):
    chainfile = "/fred/oz002/users/mmiles/MPTA_GW/enterprise_ozstar2/out_ptmcmc/PTA_RUN/RESTART2/" + dirname + '/chain_1.txt'
    ...
    plt.close()
    '''
chain_corner_from_dir(sys.argv[1], "/fred/oz002/users/mmiles/MPTA_GW/enterprise_ozstar2/out_ptmcmc/PTA_RUN/RESTART2/" + sys.argv[1]+"/pars.txt")
