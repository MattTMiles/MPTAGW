...
def co_coll(directory, pulsar):
    ...
    maindir = directory+"/"
    psr = Pulsar(maindir+pulsar+"_refit.par", maindir+pulsar+".tim", ephem="DE440")
    ...
    p0 = noise_dims["pl_clock_noise"][0] + ntmpar +1
    p1 = noise_dims["pl_clock_noise"][0] + ntmpar +1 + noise_dims["pl_clock_noise"][1]
