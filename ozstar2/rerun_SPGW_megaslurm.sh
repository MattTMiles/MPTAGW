...
if [[ ! -f "/fred/oz002/users/mmiles/MPTA_GW/enterprise_ozstar2/out_ppc/SPGW/${psr}/${psr}_SPGW600/SPGW600_result.json" ]] && [[ ! "${psr}_live_ozstar2_600_SPGW" == $(grep -w -m 1 ^${psr}_live_ozstar2_600_SPGW /fred/oz002/users/mmiles/MPTA_GW/SPGW_ozstar2_slurm.list)  ]]; then
...
if [[ ! -f "/fred/oz002/users/mmiles/MPTA_GW/enterprise_ozstar2/out_ppc/SPGW/${psr}/${psr}_SPGWC600/SPGWC600_result.json" ]] && [[ ! "${psr}_live_ozstar2_600_SPGWC" == $(grep -w -m 1 ^${psr}_live_ozstar2_600_SPGWC /fred/oz002/users/mmiles/MPTA_GW/SPGW_ozstar2_slurm.list)  ]]; then
...
if [[ ! -f "/fred/oz002/users/mmiles/MPTA_GW/enterprise_ozstar2/out_ppc/SPGW/${psr}/${psr}_SPGW1000/SPGW1000_result.json" ]] && [[ ! "${psr}_live_ozstar2_1000_SPGW" == $(grep -w -m 1 ^${psr}_live_ozstar2_1000_SPGW /fred/oz002/users/mmiles/MPTA_GW/SPGW_ozstar2_slurm.list)  ]]; then
...
if [[ ! -f "/fred/oz002/users/mmiles/MPTA_GW/enterprise_ozstar2/out_ppc/SPGW/${psr}/${psr}_SPGWC1000/SPGWC1000_result.json" ]] && [[ ! "${psr}_live_ozstar2_1000_SPGWC" == $(grep -w -m 1 ^${psr}_live_ozstar2_1000_SPGWC /fred/oz002/users/mmiles/MPTA_GW/SPGW_ozstar2_slurm.list)  ]]; then
...
if [[ ! -f "/fred/oz002/users/mmiles/MPTA_GW/enterprise_ozstar2/out_ppc/SPGW/${psr}/${psr}_SPGW600_ER/SPGW600_ER_result.json" ]] && [[ ! "${psr}_live_ozstar2_600_SPGW_ER" == $(grep -w -m 1 ^${psr}_live_ozstar2_600_SPGW_ER /fred/oz002/users/mmiles/MPTA_GW/SPGW_ozstar2_slurm.list)  ]]; then
...
if [[ ! -f "/fred/oz002/users/mmiles/MPTA_GW/enterprise_ozstar2/out_ppc/SPGW/${psr}/${psr}_SPGWC600_ER/SPGWC600_ER_result.json" ]] && [[ ! "${psr}_live_ozstar2_600_SPGWC_ER" == $(grep -w -m 1 ^${psr}_live_ozstar2_600_SPGWC_ER /fred/oz002/users/mmiles/MPTA_GW/SPGW_ozstar2_slurm.list)  ]]; then
...
if [[ ! -f "/fred/oz002/users/mmiles/MPTA_GW/enterprise_ozstar2/out_ppc/SPGW/${psr}/${psr}_SPGW1000_ER/SPGW1000_ER_result.json" ]] && [[ ! "${psr}_live_ozstar2_1000_SPGW_ER" == $(grep -w -m 1 ^${psr}_live_ozstar2_1000_SPGW_ER /fred/oz002/users/mmiles/MPTA_GW/SPGW_ozstar2_slurm.list)  ]]; then
...
if [[ ! -f "/fred/oz002/users/mmiles/MPTA_GW/enterprise_ozstar2/out_ppc/SPGW/${psr}/${psr}_SPGWC1000_ER/SPGWC1000_ER_result.json" ]] && [[ ! "${psr}_live_ozstar2_1000_SPGWC_ER" == $(grep -w -m 1 ^${psr}_live_ozstar2_1000_SPGWC_ER /fred/oz002/users/mmiles/MPTA_GW/SPGW_ozstar2_slurm.list)  ]]; then
...
if [[ ! -f "/fred/oz002/users/mmiles/MPTA_GW/enterprise_ozstar2/out_ppc/SPGW/${psr}/${psr}_FREE_SPGW600/FREE_SPGW600_result.json" ]] && [[ ! "${psr}_live_ozstar2_600_FREE_SPGW" == $(grep -w -m 1 ^${psr}_live_ozstar2_600_FREE_SPGW /fred/oz002/users/mmiles/MPTA_GW/SPGW_ozstar2_slurm.list)  ]]; then
