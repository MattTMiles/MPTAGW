...
outfile = "/fred/oz002/users/mmiles/MPTA_GW/MPTA_active_noise_models/MPTA_SPGW_noise_values.json"
...
for pulsar in psrlist:
    try:
        ...
        res = bilby.result.read_in_result(glob.glob("/fred/oz002/users/mmiles/MPTA_GW/enterprise_ozstar2/out_ppc/SPGW/"+psrname+"*/"+psrname+"_SPGWC1000/*json")[0])
