...
if [[ ! -f "/fred/oz002/users/mmiles/MPTA_GW/enterprise_ozstar2/out_ppc/PM_WN/${psr}/${psr}_PM_WN/PM_WN_result.json" ]] && [[ ! "${psr}_PM_WN" == $(grep -w -m 1 ^${psr}_PM_WN /fred/oz002/users/mmiles/MPTA_GW/PM_WN_ozstar2_slurm.list) ]]; then
...
if [[ ! -f "/fred/oz002/users/mmiles/MPTA_GW/enterprise_ozstar2/out_ppc/PM_WN/${psr}/${psr}_PM_WN_SW/PM_WN_SW_result.json" ]] && [[ ! "${psr}_PM_WN_SW" == $(grep -w -m 1 ^${psr}_PM_WN_SW /fred/oz002/users/mmiles/MPTA_GW/PM_WN_ozstar2_slurm.list) ]]; then
...
if [[ ! -f "/fred/oz002/users/mmiles/MPTA_GW/enterprise_ozstar2/out_ppc/PM_WN/${psr}/${psr}_WN_SW/WN_SW_result.json" ]] && [[ ! "${psr}_WN_SW" == $(grep -w -m 1 ^${psr}_WN_SW /fred/oz002/users/mmiles/MPTA_GW/PM_WN_ozstar2_slurm.list) ]]; then
