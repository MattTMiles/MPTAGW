...
do  
    ...
    for psr in $(cd /fred/oz002/users/mmiles/MPTA_GW/partim_portrait_fix/ && ls *tim); 
    do 
        echo ${psr%.tim}
        sh /home/mmiles/soft/GW/ozstar2/rerun_noise_live400_pbilby_fixedGW_fixedPortrait_noWN_megaslurm.sh ${psr%.tim};
    done
    rm /fred/oz002/users/mmiles/MPTA_GW/all_noise_slurm_pbilby_fixedPortrait.list
    rm /fred/oz002/users/mmiles/MPTA_GW/partim_portrait_fix/core*
