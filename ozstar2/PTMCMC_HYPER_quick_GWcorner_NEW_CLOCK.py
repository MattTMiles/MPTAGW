...
def gw_corner_all():
    ...
    chain_all = []
    burnt_chain_all = []
    for chaindir in glob.glob("/fred/oz002/users/mmiles/MPTA_GW/enterprise_ozstar2/out_ptmcmc/PTA_RUN/HYPER_NEW_CLOCK/CRN_ER_run*"):
    ...
    fig.savefig("/fred/oz002/users/mmiles/MPTA_GW/enterprise_ozstar2/out_ptmcmc/PTA_RUN/HYPER_NEW_CLOCK/CRN_PL_ER_GW_trimmed_corner_3sigma_noKDE.png")
    fig.clf()

    np.save("/fred/oz002/users/mmiles/MPTA_GW/enterprise_ozstar2/out_ptmcmc/PTA_RUN/HYPER_NEW_CLOCK/CRN_ER_GW_updated",chaingw)
