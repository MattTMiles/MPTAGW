...
def gw_corner_all():
    ...
    chain_all = []
    burnt_chain_all = []
    for chaindir in glob.glob("/fred/oz002/users/mmiles/MPTA_GW/enterprise_ozstar2/out_ptmcmc/PTA_RUN/RESTART2/CRN_ER_run*"):
    ...
    fig.savefig("/fred/oz002/users/mmiles/MPTA_GW/enterprise_ozstar2/out_ptmcmc/PTA_RUN/RESTART2/CRN_PL_ER_GW_corner.png")

    np.save("/fred/oz002/users/mmiles/MPTA_GW/enterprise_ozstar2/out_ptmcmc/PTA_RUN/RESTART2/CRN_ER_GW_updated",chaingw)
    np.save("/fred/oz002/users/mmiles/MPTA_GW/enterprise_ozstar2/out_ptmcmc/PTA_RUN/RESTART2/CRN_ER_all_updated",chainall)
    np.save("/fred/oz002/users/mmiles/MPTA_GW/enterprise_ozstar2/out_ptmcmc/PTA_RUN/RESTART2/CRN_ER_burntall_updated",burntchainall)
