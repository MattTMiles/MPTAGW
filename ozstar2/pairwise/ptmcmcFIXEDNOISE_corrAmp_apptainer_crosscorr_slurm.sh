...
apptainer run -B /fred,$HOME /fred/oz002/users/mmiles/apptainer_DJRfix.sif python /home/mmiles/soft/GW/ozstar2/pairwise/enterprise_run_cross_corrs_FIXEDNOISE_corrAmp_pbilby.py -pair $1 $2 -results ${1}_${2} -alt_dir /fred/oz002/users/mmiles/MPTA_GW/enterprise_newdata/PAIRWISE_FIXED_NOISE/corrAmp_runs/${1}_${2}/ -sampler hyper 
