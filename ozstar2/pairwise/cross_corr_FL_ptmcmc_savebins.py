        ...
        try:
            ...
            if len(res_pair) > 500:
                ...
                if scalep.max() > (np.median(scalep) + (3*np.std(scalep))):
                    ...
                    scale_count +=1
                    os.system("touch "+pairname+"_"+pairbin+"suspect")
...
np.save("/fred/oz002/users/mmiles/MPTA_GW/PAIRWISE_NEW/p_total_1", p_total_1)
np.save("/fred/oz002/users/mmiles/MPTA_GW/PAIRWISE_NEW/p_total_2", p_total_2)
np.save("/fred/oz002/users/mmiles/MPTA_GW/PAIRWISE_NEW/p_total_3", p_total_3)
np.save("/fred/oz002/users/mmiles/MPTA_GW/PAIRWISE_NEW/p_total_4", p_total_4)
np.save("/fred/oz002/users/mmiles/MPTA_GW/PAIRWISE_NEW/p_total_5", p_total_5)
np.save("/fred/oz002/users/mmiles/MPTA_GW/PAIRWISE_NEW/p_total_6", p_total_6)
np.save("/fred/oz002/users/mmiles/MPTA_GW/PAIRWISE_NEW/p_total_7", p_total_7)
...
#bin_list = [p_total_1, p_total_2, p_total_3, p_total_4, p_total_5, p_total_6, p_total_7]
...
axes.violinplot(bin_list,positions=angles, points=100, bw_method=0.35, showextrema=False, showmedians=True, quantiles=([[0.16,0.84]]*plotting_bins))
...
plt.savefig("/fred/oz002/users/mmiles/MPTA_GW/PAIRWISE_NEW/pairwise_cross_corr_temp_PTMCMC_341_outlierRejector.png")
plt.show()
