...
for pair in pp_list:
    ...
    if "J0000000" not in pairname:
        ...
        try:
            ...
            try:
                res_pair = np.loadtxt(cross_corr_dir + "/" + pairname + "/master_chain.txt")
            except:
                trialpd = pd.read_csv(cross_corr_dir + "/" + pairname + "/master_chain.txt", sep="\t", header=None, on_bad_lines="skip")
