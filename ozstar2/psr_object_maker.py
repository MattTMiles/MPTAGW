...
parser.add_argument("-noise_search", type = str.lower, nargs="+",dest="noise_search", help="The noise parameters to search over. Timing model is default. Include as '-noise_search noise1 noise2 noise3' etc. The _c variations of the noise redirects the noise to the constant noisefile values", \
    choices={"single_bin_cross_corr", "single_bin_cross_corr_er", "single_bin_cross_corr_er_altgamma", "single_bin_cross_corr_altgamma", "crn_433"})
...
for n in noise:
    if "single_bin_cross_corr" == n:
        ...
        crn = custom_common_red_noise_block(psd='powerlaw', prior='log-uniform', gamma_val=3.41, components=1, orf="single_bin_orf", name='gw_bins')
        ...
        crn = gp_signals.FourierBasisGP(spectrum=gpl, components=30, Tspan=Tspan, name='gwb')
