...
do  
    ...
    for psr in $(cat /fred/oz002/users/mmiles/MPTA_GW/enterprise_newdata/DJR_noise/psr_fixedWN.list); 
    do 
        echo ${psr}
        sh /home/mmiles/soft/GW/ozstar2/rerun_noise_live400_pbilby_DJR_noise_fixedWN.sh ${psr};
    done
