...
outdir = "/fred/oz002/users/mmiles/MPTA_GW/enterprise_newdata/out_ptmcmc/HD_reweighting/fake_pta/out_ptmcmc/HD_reweight/HD_RW_loud_{0}".format(output_num)
...
pta_CRN_file = "/fred/oz002/users/mmiles/MPTA_GW/enterprise_newdata/out_ptmcmc/HD_reweighting/fake_pta/partim/simmed_data_13/MPTA_CRN_loud.pkl"
pta_HD_file = "/fred/oz002/users/mmiles/MPTA_GW/enterprise_newdata/out_ptmcmc/HD_reweighting/fake_pta/partim/simmed_data_13/MPTA_HD_loud.pkl"

#pta_CRN = dill.load(open(pta_CRN_file,"rb"))
pta_HD = dill.load(open(pta_HD_file,"rb"))

posterior_CRN_file = "/fred/oz002/users/mmiles/MPTA_GW/enterprise_newdata/out_ptmcmc/HD_reweighting/fake_pta/out_ptmcmc/CRN_loud_thinned.npy"
    ...
    for i in tqdm(range(N), position=0, leave=True):
        ...
        if len(weights) > 4:
            if len(weights) % 5 == 0:
                ...
                p_HD_gwamp = partial_HD_post_save[:,-6]
                p_HD_gwgamma = partial_HD_post_save[:,-7]
