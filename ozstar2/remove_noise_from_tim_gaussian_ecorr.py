...
def lazy_noise_reducer(parfile, timfile, datadir):
    ...
    with open(maindir+timfile,"r") as original, open(maindir+"/"+psrname+"_off.tim","w") as newfile:
...
glsfit1, model1, noise_df1 = lazy_noise_reducer(parfile, timfile, datadir)
