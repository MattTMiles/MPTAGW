...
def chain_corner_from_dir(pulsar, parstxt):
    pulsar_dir = "/fred/oz002/users/mmiles/MPTA_GW/enterprise_ozstar2/out_ptmcmc/SMBHB_CONST/" + pulsar
    chainfiles = glob.glob("/fred/oz002/users/mmiles/MPTA_GW/enterprise_ozstar2/out_ptmcmc/SMBHB_CONST/" + pulsar + '/*SMBHB_CONST_ER_CHROMANNUAL*/chain_1.txt')
    ...
    figsavename = pulsar_dir + '/{}_corner_chromannual'.format(pulsar) + \
...
chain_corner_from_dir(sys.argv[1], sys.argv[1]+"/pars_chrom.txt")
