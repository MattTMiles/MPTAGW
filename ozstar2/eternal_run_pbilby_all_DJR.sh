...
do  
    ...
    for psr in $(cd /fred/oz002/dreardon/mk_gw/pipeline/djr_final_final_final_august/ && ls *tim); 
    do 
        echo ${psr%.tim}
        sh /home/mmiles/soft/GW/ozstar2/rerun_noise_live400_pbilby_DJR_noise.sh ${psr%.tim};
    done
