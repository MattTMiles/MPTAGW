...
for p, t in zip(parfiles,timfiles):
    ...
    #if psr.name != "J1455-3330":
    psrs.append(psr)



noisefile = '/fred/oz002/users/mmiles/MPTA_GW/SMBHB/new_models/august23data/MPTA_WN_models.json'
...
crn = blocks.common_red_noise_block(psd='powerlaw', prior='log-uniform', Tspan=Tspan, components=1,gamma_val=4.33, name='gw')
...
with open('/fred/oz002/users/mmiles/MPTA_GW/SMBHB/SMBHB_simulated_data/OS_just_SMBHB/MPTA_noise_values_allpulsars.json', "r") as f:
    ml_params = json.load(f)
...
rho_expected=OS*get_HD_curve(xi)
