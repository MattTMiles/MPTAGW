...
outdir = "/fred/oz002/users/mmiles/MPTA_GW/enterprise_newdata/out_ptmcmc/HD_reweighting/CRN/HD_RJsample_{0}".format(output_num)
        ...
        if len(weights) > 4:
            ...
            if len(weights) % 100 == 0:
                try:
                    ...
                    print("Likely lack of samples for corner plot")
