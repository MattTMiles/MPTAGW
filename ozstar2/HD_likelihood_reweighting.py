...
outdir = "/fred/oz002/users/mmiles/MPTA_GW/enterprise_ozstar2/out_ptmcmc/PTA_RUN/HYPER_HD_reweighted/HD_RW_{0}".format(output_num)
...
pta_HD_file = "/fred/oz002/users/mmiles/MPTA_GW/enterprise_ozstar2/out_ptmcmc/pta_objects/PTA_HD_PL_CRN.pkl"

#pta_CRN = dill.load(open(pta_CRN_file,"rb"))
pta_HD = dill.load(open(pta_HD_file,"rb"))

posterior_CRN_file = "/fred/oz002/users/mmiles/MPTA_GW/enterprise_ozstar2/out_ptmcmc/PTA_RUN/HYPER/CRN_ER_all_updated.npy"
    ...
    for i in tqdm(range(N), position=0, leave=True):
        ...
        if len(weights) > 10:
            if len(weights) % 50 == 0:
                ...
                p_HD_gwamp = posterior_HD_save[-6,:]
            ...
            if len(weights) % 100 == 0:
                ...
                p_HD_gwgamma = posterior_HD_save[-7,:]
