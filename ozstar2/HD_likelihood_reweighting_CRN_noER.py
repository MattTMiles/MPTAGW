...
outdir = "/fred/oz002/users/mmiles/MPTA_GW/enterprise_newdata/out_ptmcmc/HD_reweighting/CRN/HD_RW_{0}".format(output_num)
...
pta_CRN_file = "/fred/oz002/users/mmiles/MPTA_GW/enterprise_newdata/out_ptmcmc/pta_objects/MPTA_CRN.pkl"
pta_HD_file = "/fred/oz002/users/mmiles/MPTA_GW/enterprise_newdata/out_ptmcmc/pta_objects/MPTA_HD.pkl"

#pta_CRN = dill.load(open(pta_CRN_file,"rb"))
pta_HD = dill.load(open(pta_HD_file,"rb"))

posterior_CRN_file = "/fred/oz002/users/mmiles/MPTA_GW/enterprise_newdata/out_ptmcmc/PTA_RUN/CRN_all_updated_short.npy"
