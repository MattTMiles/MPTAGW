...
noise_dir = "/fred/oz002/users/mmiles/MPTA_GW/enterprise/out_ppc/PM_WN"
#noise_dir
os.chdir(partim)
...
#for pulsar in ["J1909-3744"]:
    ...
    try:
        ...
        result = bilby.result.read_in_result(glob.glob(noise_dir+"/"+pulsar+"/"+pulsar+"*PM_WN_SW/*json")[0])
