...
sw_dir = "/fred/oz002/users/mmiles/MPTA_GW/enterprise/out_ppc/PM_WN/"
pm_dir = "/fred/oz002/users/mmiles/MPTA_GW/enterprise/MPTA_active_noise_models/MPTA_PM"
...
for psr in open(pulsar_list,"r").readlines():
    ...
    if res_sw > res_pm + 2:
        ...
        os.system("echo "+chosensw+" >> /fred/oz002/users/mmiles/MPTA_GW/enterprise/SW_vs_PM.txt")
    else:
        #if "ecorr" in wnmodels:
        print(psr + ": Solar wind not preferred")
        os.system("echo "+chosen_short+" >> /fred/oz002/users/mmiles/MPTA_GW/enterprise/SW_vs_PM.txt")
