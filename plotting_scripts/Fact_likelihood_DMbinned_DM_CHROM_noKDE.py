...
for pulsar in to_use:
    ...
    if psrname != "J00000":
        ...
        try:
            ...
            newxbins2d = np.linspace(-18,-11,nbins)
            newybins2d = np.linspace(0,7,nbins)
...
fig = corner.corner(np.array([DMampsample20,DMgammasample20]).T, range=[(-18, -11),(0, 7)], bins=20, labels=[r"$\mathrm{log_{10}A_{DM}}$", r"$\gamma_\mathrm{DM}$"], color = cmap[0], plot_density=True, density=True)
corner.corner(np.array([DMampsample40,DMgammasample40]).T, range=[(-18, -11),(0, 7)], bins=20, labels=[r"$\mathrm{log_{10}A_{DM}}$", r"$\gamma_\mathrm{DM}$"], color = cmap[1], plot_density=True,density=True, fig=fig)
corner.corner(np.array([DMampsample60,DMgammasample60]).T, range=[(-18, -11),(0, 7)], bins=20, labels=[r"$\mathrm{log_{10}A_{DM}}$", r"$\gamma_\mathrm{DM}$"], color = cmap[2], plot_density=True,density=True, fig=fig)
corner.corner(np.array([DMampsample80,DMgammasample80]).T, range=[(-18, -11),(0, 7)], bins=20, labels=[r"$\mathrm{log_{10}A_{DM}}$", r"$\gamma_\mathrm{DM}$"], color = cmap[3], plot_density=True,density=True, fig=fig)
corner.corner(np.array([DMampsample100,DMgammasample100]).T, range=[(-18, -11),(0, 7)], bins=20, labels=[r"$\mathrm{log_{10}A_{DM}}$", r"$\gamma_\mathrm{DM}$"], color = cmap[4], plot_density=True,density=True, fig=fig)
corner.corner(np.array([DMampsampleother,DMgammasampleother]).T, range=[(-18, -11),(0, 7)], bins=20, labels=[r"$\mathrm{log_{10}A_{DM}}$", r"$\gamma_\mathrm{DM}$"], color = cmap[5], plot_density=True,density=True, fig=fig)
...
fig.savefig("/fred/oz002/users/mmiles/MPTA_GW/noise_paper_plots_tables/DM_factorised_likelihood_through_DM_noKDE.png")
fig.clf()

chrom_labels = []

fig = corner.corner(np.array([CHROMampsample20,CHROMgammasample20]).T, range=[(-18, -11),(0, 7)], bins=20, labels=[r"$\mathrm{log_{10}A_{CHROM}}$", r"$\gamma_\mathrm{CHROM}$"], color = cmap[0], plot_density=True, density=True)
chrom_labels.append("DM < 20")
try:
    corner.corner(np.array([CHROMampsample40,CHROMgammasample40]).T, range=[(-18, -11),(0, 7)], bins=20, labels=[r"$\mathrm{log_{10}A_{CHROM}}$", r"$\gamma_\mathrm{CHROM}$"], color = cmap[1], plot_density=True,density=True, fig=fig)
    chrom_labels.append("20 < DM < 40")
except:
    pass
try:
    corner.corner(np.array([CHROMampsample60,CHROMgammasample60]).T, range=[(-18, -11),(0, 7)], bins=20, labels=[r"$\mathrm{log_{10}A_{CHROM}}$", r"$\gamma_\mathrm{CHROM}$"], color = cmap[2], plot_density=True,density=True, fig=fig)
    chrom_labels.append("40 < DM < 60")
except:
    pass
try:
    corner.corner(np.array([CHROMampsample80,CHROMgammasample80]).T, range=[(-18, -11),(0, 7)], bins=20, labels=[r"$\mathrm{log_{10}A_{CHROM}}$", r"$\gamma_\mathrm{CHROM}$"], color = cmap[3], plot_density=True,density=True, fig=fig)
    chrom_labels.append("60 < DM < 80")
except:
    pass
try:
    corner.corner(np.array([CHROMampsample100,CHROMgammasample100]).T, range=[(-18, -11),(0, 7)], bins=20, labels=[r"$\mathrm{log_{10}A_{CHROM}}$", r"$\gamma_\mathrm{CHROM}$"], color = cmap[4], plot_density=True,density=True, fig=fig)
    chrom_labels.append("80 < DM < 100")
except:
    pass
try:
    corner.corner(np.array([CHROMampsampleother,CHROMgammasampleother]).T, range=[(-18, -11),(0, 7)], bins=20, labels=[r"$\mathrm{log_{10}A_{CHROM}}$", r"$\gamma_\mathrm{CHROM}$"], color = cmap[5], plot_density=True,density=True, fig=fig)
...
fig.legend(handles = legend_elements, fontsize=12)
#fig.legend(["CRN", "HD reweighted"])
fig.savefig("/fred/oz002/users/mmiles/MPTA_GW/noise_paper_plots_tables/Chrom_factorised_likelihood_through_DM_noKDE.png")
fig.clf()